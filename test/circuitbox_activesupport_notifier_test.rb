require 'test_helper'
require 'circuitbox/activesupport_notifier'
...
describe Circuitbox::Notifier do
  it "[notify] sends an ActiveSupport::Notification" do
    ...
    Circuitbox::ActiveSupportNotifier.new(:yammer, 12).notify(:open)
  end
  ...
  it "[notify_warning] sends an ActiveSupport::Notification" do
    ...
    Circuitbox::ActiveSupportNotifier.new(:yammer, 12).notify_warning('hello')
  end
  ...
  it '[gauge] sends an ActiveSupport::Notifier' do
    ...
    Circuitbox::ActiveSupportNotifier.new(:yammer, 12).metric_gauge(:ratio, 12)
  end
end
